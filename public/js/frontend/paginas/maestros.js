document.addEventListener('DOMContentLoaded', () => {
    ...
    const botonesToggleMaestros = document.querySelectorAll('.botonToggleMaestros');
    botonesToggleMaestros.forEach(boton => {
        boton.addEventListener('click', () => {
            const tarjetaPadre = boton.closest('.tarjetaDesplegableAula');
            if (tarjetaPadre) {
                tarjetaPadre.classList.toggle('activo');
            }
        });
    });
