document.addEventListener('DOMContentLoaded', () => {
    ...
    const botonesAcordeonHub = document.querySelectorAll('.botonAcordeonPregunta');
    botonesAcordeonHub.forEach(boton => {
        boton.addEventListener('click', () => {
            const bloquePadre = boton.closest('.bloqueAcordeonItem');
            if (bloquePadre) {
                bloquePadre.classList.toggle('activo');
            }
        });
    });
