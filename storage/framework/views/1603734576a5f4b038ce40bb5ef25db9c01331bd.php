<?php $__env->startSection('title','Mi Volcán Interior — Miniminds'); ?>
<?php $__env->startSection('extra_styles'); ?>
<link href="<?php echo e(asset('css/juegos/volcan-interior.css')); ?>" rel="stylesheet">
...
<div id="vi-wrap">
  ...
  <div class="vi-screen" id="vi-end-screen">
    ...
    <div class="vi-end-btns">
      ...
      <button class="vi-btn-back" onclick="location.href='<?php echo e(route('juegos.index')); ?>'">Otros juegos</button>
    </div>
  </div>

</div>

<script src="<?php echo e(asset('js/juegos/volcan-interior.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.paciente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abc\Desktop\Miniminds unido sophi y kelly\resources\views/juegos/volcan_interior.blade.php ENDPATH**/ ?>