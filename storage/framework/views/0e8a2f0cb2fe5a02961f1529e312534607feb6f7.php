...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/frontend/neurodiver.css')); ?>">
...
<section class="contenido-neuro">
    ...
    <div class="tarjetas-grid">
        ...
        <div class="tarjeta-neuro">
            ...
            <a href="<?php echo e(route('divergencia')); ?>">Ver información →</a>
        </div>
        ...
        <div class="tarjeta-neuro">
            ...
            <a href="<?php echo e(route('tdah')); ?>">Ver información →</a>
        </div>
        ...
        <div class="tarjeta-neuro">
            ...
            <a href="<?php echo e(route('tda')); ?>">Ver información →</a>
        </div>
...
<section class="contenido-neuro">
    ...
    <div class="tarjetas-grid">
        ...
        <div class="tarjeta-neuro">
            ...
            <a href="<?php echo e(route('dislexia')); ?>">Ver información →</a>
        </div>
...
</html><?php /**PATH C:\Users\DELL\Desktop\panditas gang\resources\views/neurodiver.blade.php ENDPATH**/ ?>