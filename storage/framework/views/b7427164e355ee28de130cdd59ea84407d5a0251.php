...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <link rel="stylesheet" href="<?php echo e(asset('css/frontend/contacto.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/frontend/modo-oscuro/contactodark.css')); ?>">
...
<section class="contactsecc1">
    ...
    <div class="contact-izquierda">
        ...
        <img src="<?php echo e(asset('/IMG/DIBUJOS/contacto2.svg')); ?>"  class="mascota">
        ...
        <div class="dato-contacto">
            <img src="<?php echo e(asset('/IMG/telefono.png')); ?>" alt="">
            <p>(+503) 1234-5678</p>
        </div>

        <div class="dato-contacto">
            <img src="<?php echo e(asset('/IMG/correo.png')); ?>" alt="">
    ...
    <div class="contact-derecha">
        ...
        <div class="alert alert-success" style="background:#d1f7d6;padding:10px 14px;border-radius:8px;margin-bottom:14px;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
        ...
        <form action="<?php echo e(route('contacto.enviar')); ?>" method="POST">
            ...
            <div class="campo">
                <label>Mensaje</label>
                <textarea name="mensaje" placeholder="Escribe tu mensaje aquí..." required><?php echo e(old('mensaje')); ?></textarea>
            </div>
...
</html><?php /**PATH C:\Users\DELL\Desktop\panditas gang\resources\views/contacto.blade.php ENDPATH**/ ?>