...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/frontend/carga.css')); ?>">
</head>
<body>
...
<div class="auth-card">
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" data-mm-loading>
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\DELL\Desktop\panditas gang\resources\views/auth/register.blade.php ENDPATH**/ ?>