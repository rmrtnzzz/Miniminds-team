...
<head>
    ...
    <link href="<?php echo e(asset('css/especialista/layout.css')); ?>" rel="stylesheet">
...
<body data-panel-theme-base="light">
    ...
    <div class="pt-topbar">
        ...
        <div class="icons">
            ...
            <a href="<?php echo e(route('especialista.perfil')); ?>" class="pt-user-chip">
...
</html><?php /**PATH C:\Users\abc\Desktop\Miniminds unido sophi y kelly\resources\views/layouts/especialista.blade.php ENDPATH**/ ?>