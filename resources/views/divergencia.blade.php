...
<head>
    ...
    <title>TEA-Neurodivergencia</title>
            <link rel="stylesheet" href="{{ asset('css/frontend/diver.css') }}">
                    ...
                    <div class="navbar-wrapper">
                        <div class="navbar-container">
                            <div class="navbar-content">
                                ...
                                <a href="{{ route('home') }}"><button class="nav-btn">
                                        Inicio
                                    </a></button>
                    <div class="nav-item">
        ...
        <div class="tarjeta-blanca-destacada">
            <div class="pq-contenido-grid">
                ...
                <div class="pq-img-col">
                    <img src="{{ asset('/IMG/LOGOTEMp.png') }}" alt="Ilustración Espectro Autista">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="seccion-bloque funciona">
        ...
        <div class="contenedor-funciona">
            ...
            <div class="centro centro-cerebro">
                @include('partials.cerebro-brain', ['height' => '480px', 'showHeader' => false])
            </div>
    ...
    <section class="seccion-bloque desarrollo-contenedor">
        <div class="qes tarjeta-suave">
            <div class="qes-imagen-wrapper">
                <img src="{{ asset('/IMG/LOGOTEMp.png') }}" alt="Ilustración Redes Neuronales">
            </div>
            <div class="qes-texto">
        ...
        <div class="qes tarjeta-suave inverso">
            ...
            <div class="qes-imagen-wrapper">
                <img src="{{ asset('/IMG/LOGOTEMp.png') }}" alt="Ilustración Flexibilidad Cognitiva">
            </div>
        </div>
    </section>
