...
<link href="{{ asset('css/paciente/recursos.css') }}" rel="stylesheet">
@endsection
...
<div class="mt-4">
 ...
 <div class="row g-3">
 <div class="col-md-4">
 <a href="{{ route('juegos.el_gran_orden') }}" class="text-decoration-none">
 ...
 <div class="col-md-4">
 <a href="{{ route('juegos.ritmo_zen') }}" class="text-decoration-none">
 <div class="pt-card p-3 text-center">
 ...
 <div class="col-md-4">
 <a href="{{ route('juegos.volcan_interior') }}" class="text-decoration-none">
 <div class="pt-card p-3 text-center">
