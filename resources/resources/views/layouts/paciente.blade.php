...
<head>
    ...
    <link href="{{ asset('css/paciente/layout.css') }}" rel="stylesheet">
    @yield('extra_styles')
</head>
<body>
    ...
    <div class="pt-topbar">
        ...
        <div class="icons">
            ...
            <a href="{{ route('home') }}" class="pt-home-link" title="Salir al inicio">
                <i class="fas fa-house"></i>
            </a>
            <a href="{{ route('paciente.perfil') }}" class="pt-user-chip">
    ...
    <div class="pt-shell">
        <div class="pt-sidebar">
            ...
            <a href="{{ route('paciente.historial') }}" class="{{ request()->routeIs('paciente.historial') ? 'active' : '' }}">
                <i class="fas fa-clock-rotate-left"></i> Mi historial
            </a>
